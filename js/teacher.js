...
<form autocomplete="off" class="add-teacher-form w-[981px] p-5 flex justify-around">
  ...
  <div class="space-y-[35px]">
    ...
    <label class="flex flex-col">
      ...
      <input name="age" required type="number" class="rounded-[4px] w-[400px] pl-10 font-medium text-[14px] text-[rgba(138,138,138,1)] py-4 bg-white border-[1px] border-[rgba(167,167,167,1)]" placeholder="Age" />
    </label>
    ...
    <label>
      ...
      <img class="change-img mb-[12px] mx-auto" src="" alt="img" width="150" height="150" >
    </label>
  ...
  arr.forEach((item) => {
    ...
    elTr.innerHTML = `
      ...
      <td class="texr-center py-[16px] bg-white text-center">
        <span class="font-medium text-[12px] text-[rgba(79,79,79,1)] ">${item.clas}</span>
      </td>
...
`
  ...
  let elSubmitBtn = document.querySelector(".add-btn")
    ...
    evt.preventDefault()
      ...
      email: evt.target.emailAddress.value
      subject: evt.target.chooseSubject.value
      clas: evt.target.chooseClass.value
      gender: evt.target.chooseGender.textContent
      about: evt.target.aboutInput.value
      age: evt.target.age.value
